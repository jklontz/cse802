...
br -algorithm "Open+LimitSize(128)+Grid(20,20)+SIFTDescriptor(12)+KMeans(1024)+CvtFloat+Hist(1024):Dist(L1)" -train ~/cse802/images[step=20] -compare ~/cse802/images[step=20] . 1nn.eval
